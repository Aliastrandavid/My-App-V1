...
if (isset($_GET['slug']) && !empty($_GET['slug'])) {
    ...
    if (isset($post_types[$slug])) {
        ...
        $is_new = false;
        $page_title = 'Edit Post Type: ' . htmlspecialchars($post_type['name']);
    } else {
                                ...
                                <div class="col-md-8">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" 
                                               value="<?php echo htmlspecialchars($post_type['name'] ?? ''); ?>" required>
                                        <div class="form-text">The name of the post type as it appears in the admin interface.</div>
                                    </div>
                                    
                                    <div class="mb-3">
                                        <label for="slug" class="form-label">Slug *</label>
                                        <input type="text" class="form-control" id="slug" name="slug" 
                                               value="<?php echo htmlspecialchars($post_type['slug'] ?? ''); ?>" 
